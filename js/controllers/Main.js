...
const menuPartida = document.getElementById("menuPartida");
const btnMusica = document.getElementById("btnMusicaInicio");
const btnMusicaPartida = (document.getElementById("btnMusicaPartida"));
const audio = document.getElementById("audio");
const btnComenzar = document.getElementById("btnComenzar");
const btnInicializar = (document.getElementById("btnInicializar"));
const imgOrdenador = document.getElementById("imgOrdenador");
const imgJugador = document.getElementById("imgJugador");
const puntosJugador = (document.getElementById("puntosJugador"));
const puntosOrdenador = (document.getElementById("puntosOrdenador"));
...
const bordeJugador = document.getElementById("bordeJugador");
const bordeOrdenador = (document.getElementById("bordeOrdenador"));
